/*
	File: fn_resupply_building_with_multiple_sandbag.sqf
	Author:  John Wescott a.k.a. Duke Lawrence
	Public: No
	...
	Example(s):
		[_target] call para_c_fnc_resupply_building_with_multiple_sandbag;
*/
...
{
	["resupplybuilding", [_target, "MULTISANDBAG"]] call para_c_fnc_call_on_server;
} else {

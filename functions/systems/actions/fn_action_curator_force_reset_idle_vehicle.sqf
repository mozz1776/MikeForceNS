...
private _conditionToShow = [
	...
	"(vn_mf_veh_asset_spawn_points_client get (cursorTarget getVariable 'veh_asset_spawnPointId') get 'status' get 'state' == 'IDLE')"
] joinString " && ";
...
[
	format [
		"<t color='#A04406'>%1</t>",
		"[ADMIN] Reset Idle Vehicle"
	],  // title
	{
		params ["_target", "_caller", "_actionId", "_arguments"];
		[cursorTarget getVariable "veh_asset_spawnPointId"] remoteExec ["vn_mf_fnc_veh_asset_bn_curator_force_reset_idle_vehicle", 2];
	},  // script
	nil,  // arguments
	1.5,  // priority
	true,  // showWindow

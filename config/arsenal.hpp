class vn_whitelisted_arsenal_loadouts
{
    ...
    {"vnx_m50_smg_fold", {0, 0, 0, 0}}, // M50 9mm Submachinegun. Danish SMG with folded stock
    {"vnx_type56_xm148", {0, 0, 0, 0}}, // Type 56 7.62mm Assault Rifle with XM148 single-shot 40mm grenade-launcher attached under the barrel
    {"vnx_c96", {0, 0, 0, 0}}, // C96 is a German semi-automatic pistol chambered in 7.62x25
    {"vnx_no4", {0, 0, 0, 0}}, // The No.4 Mark I Rifle is a United Kingdom service rifle
    {"vnx_no4_bayo", {0, 0, 0, 0}}, // No.4 Mk I Rifle + No.4 Bayonet
    {"vnx_no4_sniper", {0, 0, 0, 0}}, // No.4 Mk I Rifle + 3.5x No.32 Telescope
    {"vnx_m201z", {-1, 0, 0, 0}}, // M201-Z Gas Gun made in the US fires a variety of 37mm rounds
    {"vnx_stg44", {0, 0, 0, 0}}, // Sturmgewehr 44 is a German automatic rifle
	{"vnx_p08", {0, 0, 0, 0}},
	{"vnx_tul1", {0, 0, 0, 0}},
	{"vnx_m38_smg", {0, 0, 0, 0}},
    // Nickel Steel
	...
	{"vnx_m_axe_01", {0, 0, 0, 0}}, // Marine Axe
	{"vnx_m_hammer_01", {0, 0, 0, 0}}, // Marine Hammer
	{"vnx_m_pickaxe_01", {0, 0, 0, 0}}, // Marine Pickaxe
	{"vnx_m_shovel_01", {0, 0, 0, 0}}, // Marine Shovel
    ...
    //End Nickel Steel 
			...
			{"vn_svd_sniper", 						{ 0,0,-1,-1}},	//	SVD 7.62x54mm semi-automatic marksman rifle
			{"vn_svd_sniper_camo", 					{ 0,0,-1,-1}},	//	SVD 7.62x54mm semi-automatic marksman rifle
			{"vn_k98k", 							{ 0,0, 0, 0}},	//	K98K 5-shot, clip-fed, 7.92x57mm rifle
			{"vn_k98k_bayo", 						{ 0,0, 0, 0}},	//	K98K 5-shot, clip-fed, 7.92x57mm rifle
			{"vn_k98k_mrk", 						{ 0,0, 0, 0}},	//	K98K 5-shot, clip-fed, 7.92x57mm rifle
			{"vn_k98k_mrk_camo", 					{ 0,0, 0, 0}},	//	K98K 5-shot, clip-fed, 7.92x57mm rifle
			//Assault Rifles
			//BluFor
			...
			//OpFor
			{"vn_type56", 							{ 0,0, 0,-1}},	//	Type 56 7.62mm Assault Rifle. Chinese copy of AK-47 with folding cruciform bayonet
			...
			{"vn_ak_01", 							{ 0,0, 4, 2}},	//	AK 7.62x39mm Assault Rifle
			//Carbine
			//BluFor
			...
			//OpFor
			{"vn_rpd_shorty",						{ 0,0, 0,-1}},	//	RPD 7.62mm LMG, with sawn-off barrel, sight, and bipod, carried by El Cid of MACV SOG
			{"vn_rpd_shorty_01",					{ 0,0, 0,-1}},	//	RPD 7.62mm LMG, with sawn-off barrel and bipod
			{"vn_rpd",								{ 0,0, 0,-1}},	//	RPD 7.62x39mm Light Machine Gun fed by drums containing 100-round belts
			...
			{"vn_mp40",								{ 0,0, 0,-1}},	//	The MP40 is a submachinegun chambered for 9—19mm Parabellum cartridge
			...
			//OpFor
			{"vn_rpg2",								{ 0,0, 0,-1}},	//	B40 HEAT rocket
			{"vn_rpg7",								{ 0,0, 0,-1}},	//	B41 HEAT rocket
    ...
    {"vnx_37mm_cs_fin_mag", {-1, -1, 0, 0}}, // No.230 high velocity projectile designed to breech doors, windows and partions
    {"vnx_37mm_cs_mag", {-1, -1, 0, 0}}, // No.203 low velocity riot control CS Gas canister
    {"vnx_37mm_cs_skat_mag", {-1, -1, 0, 0}}, // No.265 Multiple CS canister rounds used for riot control
    {"vnx_37mm_cs_spray_mag", {-1, -1, 0, 0}}, // No.208 short range spray, will spray CS gas to 40ft in 1 second
    {"vnx_37mm_flare_mag", {-1, 0, -1, 0}}, // No.213 37mm Flare
    ...
    {"vnx_stg44_mag", {0, 0, 0, 0}}, // 30Rnds StG44 Magazine Caliber 7.92x33mm used in StG44
    {"vnx_stg44_t_mag", {0, 0, 0, 0}}, // 30Rnds StG44 Tracer Magazine Caliber 7.92x33mm used in StG44
	{"vnx_p08_mag", {0, 0, 0, 0}}, // 8rd P08 mags
	{"vnx_m38_smg_32_mag", {0, 0, 0, 0}}, // 32rd 9mm m38 smg mag 
	{"vnx_m38_smg_32_t_mag", {0, 0, 0, 0}}, // 32rd 9mm m38 tracer smg mag 
	{"vnx_rpk_40_mag", {0, 0, 0, 0}}, // 40Rnds TUL-1 Magazine Caliber 7.62x39mm
	{"vnx_rpk_40_t_mag", {0, 0, 0, 0}}, // 40Rnds TUL-1 Tracer Magazine Caliber 7.62x39mm
	{"vnx_rpk_75_mag", {0, 0, 0, 0}}, // 75Rnds TUL-1 Magazine Caliber 7.62x39mm
	{"vnx_rpk_75_t_mag", {0, 0, 0, 0}}, // 75Rnds TUL-1 Tracer Magazine Caliber 7.62x39mm
    ...
    //End Nickel Steel 
			...
			//OpFor
			{"vn_m38_mag",							{ 0,0, 0, 3}},	//	5Rnd. M38 Clip. Caliber: 7.62x54mmR. Used in M38, VZ54, M1891 and M91/30 rifles
			{"vn_m38_t_mag",						{ 0,0, 0, 3}},	//	5Rnd. M38 Tracer Clip. Caliber: 7.62x54mmR. Used in M38, VZ54, M1891 and M91/30 rifles
			{"vn_k98k_mag",							{ 0,0, 0,-1}},	//	5Rnd. K98K Clip. Caliber: 7.92x57mm. Used in K98K
			{"vn_k98k_t_mag",						{ 0,0, 0,-1}},	//	5Rnd. K98K Tracer Clip. Caliber: 7.92x57mm Used in K98K
			//Mags
			...
			//OpFor
			{"vn_type56_mag",						{ 0,0, 0,-1}},	//	30Rnd. Type 56/AK Magazine. Caliber: 7.62x39mm. Used in Type 56/AK, AK and KBKG assault rifle
			{"vn_type56_t_mag",						{ 0,0, 0,-1}},	//	30Rnd. Type 56/AK Tracer Magazine. Caliber: 7.62x39mm. Used in Type 56/AK, AK and KBKG assault rifle
			{"vn_svd_mag",							{ 0,0, 0,-1}},	//	10Rnd. SVD Mag. Caliber: 7.62x54mm. Used in SVD sniper rifle
			{"vn_svd_t_mag",						{ 0,0, 0,-1}},	//	10Rnd. SVD Tracer Magazine. Caliber: 7.62x54mm Used in SVD sniper rifle
			...
			//OpFor
			{"vn_rpd_100_mag",						{ 0,0, 0,-1}},	//	100Rnd. RPD Belt. Caliber: 7.62x39mm. Used in RPD Light machine gun
			{"vn_rpd_125_mag",						{ 0,0, 0,-1}},	//	125Rnd. RPD Belt. Caliber: 7.62x39mm. 1:1 tracer, used by US Special Forces in captured RPD machine guns
			...
			{"vn_mp40_mag",							{ 0,0, 0,-1}},	//	32Rnd. MP40 Mag
			{"vn_mp40_t_mag",						{ 0,0, 0,-1}},	//	32Rnd. MP40 Mag (Tracer)
			...
			//OpFor
			{"vn_rpg2_mag",							{ 0, 0, 0,-1}},	//	PG-2 82mm HEAT Rocket. Used in B40 hand-held, anti-tank grenade-launcher
			{"vn_rpg7_mag",							{ 0, 0, 0,-1}},	//	PG-7V 85mm HEAT Rocket. Used in B41 hand-held, anti-tank grenade-launcher
			...
			{"vn_rpg2_fuze_mag",					{ 0,0, 0,-1}},	//	PG-2 82mm Fuze Rocket. Used in B40 hand-held, anti-tank grenade-launcher
			//Explosives
...
//Headgear
	...
	{"vnx_b_armor_lvtp5c_01_usmc",		{-1, 0, 0, 0}},	// Marine Landing Vehicle
	{"vnx_b_armor_lvte1_01_usmc",		{-1, 0, 0, 0}},	// Marine Landing Vehicle
	{"vnx_b_armor_lvtr1_01_usmc",		{-1, 0, 0, 0}},	// Marine Landing Vehicle
	{"vnx_b_armor_m50_01_usmc",			{-1, 0, 0, 0}},	// Marine Ontos
	{"vnx_b_armor_m50a1_01_usmc",		{-1, 0, 0, 0}},	// Marine Ontos A1
	{"vnx_b_armor_m50_01",				{-1, 0, 0, 0}},	// Airborne Ontos
	{"vnx_b_armor_m50a1_01",			{-1, 0, 0, 0}},	// Airborne Ontos A1

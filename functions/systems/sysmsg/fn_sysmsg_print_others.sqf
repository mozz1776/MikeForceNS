...
private _other_messages = [
    ...
    // "633rd TASG: A tribute unit to the USAF unit of the same name stationed at Pleiku Airbase.",
    // "633rd TASG: Support functions with a focus on aviation support and logistics.",
    // "633rd TASG: We do what others don't want to do or are deemed dangerous.",
